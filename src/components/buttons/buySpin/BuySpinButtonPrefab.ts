...
import { BuySpinButtonViewModel } from './BuySpinButtonViewModel'


export class BuySpinButtonPrefab {

    private view: ButtonView | null = null
    private viewModel: BuySpinButtonViewModel | null = null

    public initial() {
        this.view = new ButtonView()
        this.view.initial()

        this.viewModel = new BuySpinButtonViewModel()
