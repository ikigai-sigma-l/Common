...
import { SettingButtonViewModel } from './SettingButtonViewModel'


export class SettingButtonPrefab {

    private view: ButtonView | null = null
    private viewModel: SettingButtonViewModel | null = null

    public initial() {
        this.view = new ButtonView()
        this.view.initial()

        this.viewModel = new SettingButtonViewModel()
