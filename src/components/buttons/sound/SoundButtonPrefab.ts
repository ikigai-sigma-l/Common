...
import { SoundButtonViewModel } from './SoundButtonViewModel'


export class SoundButtonPrefab {

    private view: ButtonView | null = null
    private viewModel: SoundButtonViewModel | null = null

    public initial() {
        this.view = new ButtonView()
        this.view.initial()

        this.viewModel = new SoundButtonViewModel()
