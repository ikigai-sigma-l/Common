...
import { InfoButtonViewModel } from './InfoButtonViewModel'


export class InfoButtonPrefab {

    private view: ButtonView | null = null
    private viewModel: InfoButtonViewModel | null = null

    public initial() {
        this.view = new ButtonView()
        this.view.initial()

        this.viewModel = new InfoButtonViewModel()
